...
const Navbar = () => {
  ...
  return (
    <div className="w-full max-w-[890px] h-16 sm:h-20 rounded-full border border-gray-300 mx-auto my-4 sm:my-11 shadow-[0_0_20px_0_rgba(127,127,127,0.15)] px-3 sm:px-4">
      ...
      {/* Mobile Menu */}
      {isMobileMenuOpen && (
        <div className="lg:hidden absolute top-full left-0 right-0 mt-2 bg-white rounded-2xl shadow-lg border border-gray-200 z-50 mx-2">
